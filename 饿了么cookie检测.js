...
!(async () => {
    ...
    for (let _0x42d0fb = 0; _0x42d0fb < _0x13daa4.length; _0x42d0fb++) {
        if (_0x13daa4[_0x42d0fb].Value && _0x13daa4[_0x42d0fb].Enable) {
            cookie = _0x13daa4[_0x42d0fb].Value;
            ...
            try {
                var _0x122b6e = await _0x2f660f();

                (_0x122b6e.message = "未登录") && (console.log("账号过期"), await _0x581b21("饿了么账号：" + _0x2f3cd8 + "，饿了么CK失效了，请打开饿了么APP-我的-超级吃货卡，自动复活失效CK！", false, _0x13daa4[_0x42d0fb].UserId), _0x5661d6.push(cookie));
            } catch (_0x4bef11) { }
        }
    }
